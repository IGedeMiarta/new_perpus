                 ...
                 <div class="row mb-2">
                     ...
                     <div class="col-sm-6">
                         <ol class="breadcrumb float-sm-right">
                             ...
                             <li class="breadcrumb-item"><a href="<?= base_url('owner/supplier') ?>">Supplier</a></li>
         ...
         <section class="content">
             ...
             <div class="card">
                 <div class="card-body">
                     ...
                     <form method="POST" action="<?= base_url('owner/supplier_edt_act/' . $supplier['id_sup']) ?>">
                         <div class="form-group">
                             <label>Nama Supplier</label>
                             <input type="text" class="form-control" id="sup_name" name="sup_name" placeholder="Nama Supplier" value="<?= $supplier['nama_sup'] ?>">
