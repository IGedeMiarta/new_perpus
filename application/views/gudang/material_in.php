                 ...
                 <div class="card-body">
                     <form method="POST" action="<?= base_url('gudang/material_in_act') ?>">
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-sm-10">
                                 <select name="jml" id="" class="form-control">
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-sm-10">
                                 <input type="number" name="masuk" class="form-control" placeholder="jumlah pcs" required>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-sm-2">
                             ...
                             <?php
                                ...
                                foreach ($masuk as $mtrl) { ?>
                                 <tr>
                                     ...
                                     <td class="text-center"><?= $mtrl->kemasan ?> gram</td>
                                     <td class="text-center"><?= $mtrl->jumlah ?> pcs</td>
                                     <!-- <td>
