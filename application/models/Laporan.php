...
class Laporan extends CI_Model
{
    ...
    function mtrl_keluar()
    {
        return $this->db->query("SELECT * FROM material_keluar,material WHERE material_keluar.kd_material=material.kd_material ORDER BY material_keluar.kd_material ASC")->result();
    }
    function keluar($mulai, $sampai)
    {
        return $this->db->query("SELECT * FROM material_keluar,material WHERE material_keluar.kd_material=material.kd_material AND date(waktu) >='$mulai' AND date(waktu) <= '$sampai' ORDER BY material_keluar.kd_material ASC")->result();
    }
